...
jint Java_com_adnroid_ufirephone_home_AudioCodec_audio_1codec_1init(JNIEnv *env,
...
/**  raw---->amr
 *JNI 鍑芥暟锛屽拰Java灞傜殑浠ｇ爜鍖呭悕瀵瑰簲
 浠嶫ava灞備紶鍏ヤ竴娈甸噰鏍风殑闊抽锛屽皢鍏剁紪鐮佹垚AMR
 sampleArray:閲囬泦鐨勪竴娈甸煶棰戞暟鎹� sampleOffset:閲囨牱鏁版嵁鍋忕Щ閲� sampleLength:闊抽鏁版嵁闀垮害
 dataArray锛氱紪鐮佸悗鐨勬暟鎹紝杩斿洖缁橨ava灞傝鍏跺鐞嗭紙姣斿浣跨敤UDP 鍙戦�缁欏彟涓�柟锛� dataOffset:鍋忕Щ閲忥紱
 return锛氱紪鐮佸悗鐨勬暟鎹暱搴︼紙閲囬泦960B鐨勫師濮嬫暟鎹紝缂栫爜鎴怉MR鍚庡垯杩斿洖100B锛� */

jint Java_com_adnroid_ufirephone_home_AudioCodec_audio_1encode(JNIEnv *env,
...
jint Java_com_adnroid_ufirephone_home_AudioCodec_audio_1decode(JNIEnv *env,
